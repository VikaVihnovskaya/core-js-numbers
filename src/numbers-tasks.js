...
function getFibonacciNumber(index) {
  ...
  let prev1 = 1;
  let prev2 = 0;
  let fibonacciCurrentValue = 1;

  for (let i = 2; i <= index; i += 1) {
    fibonacciCurrentValue = prev1 + prev2;

    prev2 = prev1;
    prev1 = fibonacciCurrentValue;
  }

  return fibonacciCurrentValue;
}
...
function getIntegerOnString(str, base) {
  try {
    const intValue = Number.parseInt(str, base);
    if (Number.isNaN(intValue)) {
      return Number.NaN;
    }
    return intValue;
